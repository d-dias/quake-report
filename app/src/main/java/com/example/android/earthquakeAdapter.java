...
public class earthquakeAdapter extends ArrayAdapter<earthquakes> {
    ...
    public earthquakeAdapter(Context context, List<earthquakes> earthquake) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String formattedString = decimalFormat(currentEarthquake.getMagnitude());
        magnitudeTextView.setText(formattedString);
        ...
        if (location.contains(divideWord)) {
            String[] dividedLocations = location.split(divideWord);
            locationOffset = dividedLocations[0] + divideWord;
